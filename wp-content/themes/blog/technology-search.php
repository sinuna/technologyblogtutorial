<?php
/* 
Template Name: Technology Search
*/
...
<div class="card">
    <div class="card-body">
            <form action="<?php echo home_url('/technology-search');?>">
            ...
            <div class="form-group">
                <label>Choose a Technology brand</label>
                <select name="brand" class="form-control">
                        <option value="">Choose a Technology brand</option>
            ...
            <a href="<?php echo home_url('/technology-search');?>">Reset search</a>
            </form>
